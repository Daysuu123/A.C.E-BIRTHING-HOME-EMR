...
function StaffPregnancyHistory() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setForm({ patient_id: "", gravida: "", para: "", full_term_pregnancies: "", preterm_deliveries: "", abortions: "", living_children: "", last_menstrual_period: "" });
      await fetchItems();
    } catch (e) {
      setError(e.message);
    }
  ...
  return (
    <StaffLayout title="Pregnancy History">
      ...
      <form className="form" onSubmit={handleSubmit}>
        ...
        <div className="actions">
          ...
          <button
            type="button"
            className="clear-btn"
            onClick={() => setForm({ patient_id: "", gravida: "", para: "", full_term_pregnancies: "", preterm_deliveries: "", abortions: "", living_children: "", last_menstrual_period: "" })}
          >
            Clear
          </button>
        </div>
...
export default StaffPregnancyHistory;